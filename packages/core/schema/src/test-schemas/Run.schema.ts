...
export default {
  types: {
    ...
    RatePerceivedExertion: {
      ...
      dataType: DataType.Enum,
      members: {
        $0: { description: "No exertion.", value: "0" },
        $05: { description: "Noticeable.", value: "0.5" },
        $1: { description: "Very light.", value: "1" },
        $2: { description: "Light.", value: "2" },
        $3: { description: "Moderate.", value: "3" },
        $4: { description: "Somewhat difficult.", value: "4" },
        $5: { description: "Difficult.", value: "5" },
        $6: { description: "Difficult.", value: "6" },
        $7: { description: "Very difficult.", value: "7" },
        $8: { description: "Very difficult.", value: "8" },
        $9: { description: "Almost maximal.", value: "9" },
        $10: { description: "Maximal.", value: "10" },
      },
    },
    WeatherCondition: {
