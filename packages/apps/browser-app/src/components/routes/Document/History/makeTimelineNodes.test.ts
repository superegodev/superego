...
function makeVersion(createdAt: Date): LiteDocumentVersion {
  return {
...
it("returns single version as-is", () => {
  // Exercise
  const version = makeVersion(new Date("2025-01-10T10:00:00Z"));
...
it("keeps latest version as individual node even when in same bucket", () => {
  // Exercise
  const versions = [
    makeVersion(new Date("2025-01-10T10:00:00Z")),
    makeVersion(new Date("2025-01-10T10:30:00Z")),
    makeVersion(new Date("2025-01-10T11:00:00Z")),
  ];
...
it("groups versions by hour when span < 1 day", () => {
  ...
  const versions = [
    makeVersion(new Date("2025-01-10T10:00:00Z")),
    makeVersion(new Date("2025-01-10T10:30:00Z")),
    makeVersion(new Date("2025-01-10T12:00:00Z")),
    makeVersion(new Date("2025-01-10T12:30:00Z")),
  ];
  const nodes = makeTimelineNodes(versions);
...
it("groups versions by day when span is between 1 day and 1 week", () => {
  ...
  const versions = [
    makeVersion(new Date("2025-01-10T10:00:00Z")),
    makeVersion(new Date("2025-01-10T14:00:00Z")),
    makeVersion(new Date("2025-01-12T10:00:00Z")),
    makeVersion(new Date("2025-01-12T14:00:00Z")),
  ];
  const nodes = makeTimelineNodes(versions);
...
it("groups versions by ISO week when span is between 1 week and 1 month", () => {
  // Exercise
  const versions = [
    makeVersion(new Date("2025-01-06T10:00:00Z")), // Week 2.
    makeVersion(new Date("2025-01-08T10:00:00Z")), // Week 2.
    makeVersion(new Date("2025-01-13T10:00:00Z")), // Week 3.
    makeVersion(new Date("2025-01-15T10:00:00Z")), // Week 3.
  ];
  const nodes = makeTimelineNodes(versions);
...
it("groups versions by month when span > 1 month", () => {
  // Exercise
  const versions = [
    makeVersion(new Date("2025-01-15T10:00:00Z")),
    makeVersion(new Date("2025-02-15T10:00:00Z")),
    makeVersion(new Date("2025-03-15T10:00:00Z")),
  ];
  const nodes = makeTimelineNodes(versions);
