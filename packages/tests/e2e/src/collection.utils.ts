...
export async function createCollection(page: Page, collectionOptions: CollectionOptions) {
  ...
  await page.getByRole("textbox", { name: "Schema" }).fill(JSON.stringify(schema, null, 2));
  // Set value getter
